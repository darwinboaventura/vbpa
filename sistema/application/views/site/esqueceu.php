                  ...
                  <div class="login-box-body">
                        ...
                        <form action="<?php echo base_url('login/password');?>" method="post">
                              <div class="form-group has-feedback">
                                    <input type="text" class="form-control" name="cnpj" placeholder="Qual o seu login?" />
                              ...
                              <div class="row">
                        		<div class="col-xs-6">
                                    ...
                                    <div class="col-xs-6">
                                          <button type="submit" class="btn btn-primary btn-block btn-flat submit-login-site">Solicitar senha</button>
                                    </div><!-- /.col -->
                              </div>
                        </form>
