		<footer id="main-footer" class="clearfix">
			...
			<div class="row-middle clearfix wrapper">
				...
				<p class="el-copyright">
					Copyright © 2016 - Todos os direitos reservados à <br />
					VBPA -Auditores & Consultores <br />
					Assessoria Contábil e Consultoria
				</p>
				...
				<a href="http://www.grupoa2.com.br" target="_blank" class="el-brand">
					<img src="<?php echo base_url();?>assets/site//imgs/marca-grupoa-a2.png" alt="DESENVOLVIDO PELO GRUPO A2">
				</a>
			</div>
		</footer>
		
		<nav id="mobile-menu" class="clearfix">
			<a href="#" class="el-close">Fechar</a>
